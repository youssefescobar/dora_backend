...
router.post('/unassign-band', authorize('moderator', 'admin'), validate(require('../middleware/schemas').user_action_schema), group_controller.unassign_band_from_pilgrim);
